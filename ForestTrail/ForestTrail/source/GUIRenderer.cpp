...
namespace GE {
	...
	void GUIRenderer::init()
	{
		...
		std::string v_shader_source = loadShaderSourceCode("./shaders/GUI.vert");
		std::string f_shader_source = loadShaderSourceCode("./shaders/GUI.frag");
		...
		projectionMat = glm::ortho(0.0f, (float)w, (float)h, 0.0f);
	}
