...
namespace GE {
	...
	private:
		...
		// This member stores the attribute to select into the pipeline to link the triangle vertices to the pieline
		GLuint vertexLocation;

		// This member stores the triangle vertex buffer object containing the vertices transferred from this code to the graphics memory
		GLuint vboSkybox;
